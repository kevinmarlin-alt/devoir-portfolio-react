            ...
            <div className="container">
                <div className="row pt-5 pb-3">
                    ...
                    <section className="col-md-4 mb-4">
                        <h5 className="fs-5 mb-2">John Doe</h5>
                        <address>
                        ...
                        <div>
                            <a href="https://github.com/github-john-doe" className="link-secondary pe-2" rel="noreferrer" target="_blank">
                            ...
                            <a href="https://x.com" className="link-secondary pe-2" rel="noreferrer" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
                                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                                </svg>
                            </a>
                        
                            <a href="https://fr.linkedin.com/?trk=guest_homepage-basic_nav-header-logo" className="link-secondary pe-2" rel="noreferrer" target="_blank">
                    ...
                    <section className="col-md-4 mb-4">
                        <h5 className="fs-5 mb-2">Liens utiles</h5>
                        <ul>
                            <li className="fs-6 mb-0">
                    ...
                    <section className="col-md-4">
                        <h5 className="fs-5 mb-2">Mes dernières réalisations</h5>
                        <ul>
                            <li className="fs-6 mb-0">
                            ...
                            <li className="fs-6 mb-0">
                                <Link to="/portfolio">Maquette de site</Link>
                            </li>
                        </ul>
                    </section>
                </div>
