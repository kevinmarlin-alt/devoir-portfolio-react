        ...
        <main>
            ...
            <div className="container px-4 mb-5">
                <div className="row g-4">
                    <ServiceCard 
                        svg={
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-brush text-primary" viewBox="0 0 16 16">
                    ...
                    <ServiceCard 
                        svg={
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-code-slash text-primary" viewBox="0 0 16 16">
                    ...
                    <ServiceCard 
                        svg={
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-search text-primary" viewBox="0 0 16 16">
